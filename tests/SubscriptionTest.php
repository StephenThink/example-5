...
{
    /**
     * It creates a stripe subscription
     *
     * @test
     */
    ...
    /**
     * Creating a subscription marks the user as subscribed
     *
     * @test
     * @throws Exception
     */
    ...
    {
//        $gateway = new DummyGateway(); // don't use the actual Gateway. Use a dummy/fake version.
